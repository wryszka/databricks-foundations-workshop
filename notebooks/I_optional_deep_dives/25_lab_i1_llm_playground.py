...
# MAGIC %md
# MAGIC # I1 — LLM primer: the AI Playground and foundation models
# MAGIC
...
# TODO: complete the ai_query call — pass LLM_ENDPOINT and a prompt string
result = spark.sql(f"""
    SELECT ai_query('{LLM_ENDPOINT}',
      '' -- TODO: write a prompt, e.g. explain what a no-claims discount is
    ) AS answer
""")
